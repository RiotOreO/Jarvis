...
@jarvis_cmd(pattern="q( (.*)|$)", manager=True, allow_pm=True)
async def quott_(event):
    ...
    message = await reply.reply("quotly by Jarvis", file=file)
    os.remove(file)
    await msg.delete()
    return message
