...
**Jarvis [v{jarvis_version}](https://github.com/btworeo/Jarvis), powered by @MyJarvis**
"""
...
async def jarvis(event):
    ...
    if event.sender_id not in SUDO_M.fullsudos:
        ok = ""
        me = inline_mention(jarvis_bot.me)
        ...
        if not udB.get_key("STARTMSG"):
            ...
            await event.reply(
                f"Hey there {mention}, this is Jarvis Assistant of {me}!\n\n{ok}",
