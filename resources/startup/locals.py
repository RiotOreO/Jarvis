...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to Jarvis, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    os.system("rm -rf Jarvis")
    os.system("git clone https://github.com/btworeo/Jarvis")
    print("\n\nDone")
    os.chdir("Jarvis")
    clear_screen()
    print(a)
    ...
    all_done = "# Jarvis Environment Variables.\n# Do not delete this file.\n\n"
    for i in varrs:
        all_done += do_input(i)
    clear_screen()
    print(a)
